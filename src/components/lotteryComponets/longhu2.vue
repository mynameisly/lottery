 ...
 * @LastEditTime: 2020-10-18 15:25:56
...
<template>
  <div class="lotteryType-box">
    <div class="title">大小单双</div>
    <div class="content-box">
      <div class="left-box">
        <div class="left-content">
          <div class="item">
            <span class="num" id="1"  :class="selectId.indexOf(0) > -1 ? 'selectItem' : ''"  @click="activeItem(0)">大</span>
          </div>
          <div class="item">
            <span class="num" id="2" :class="selectId.indexOf(1) > -1 ? 'selectItem' : ''"  @click="activeItem(1)">小</span>
          </div>
          <div class="item">
            <span class="num" id="3" :class="selectId.indexOf(2) > -1 ? 'selectItem' : ''"  @click="activeItem(2)">单</span>
          </div>
          <div class="item">
            <span class="num" id="4" :class="selectId.indexOf(3) > -1 ? 'selectItem' : ''"  @click="activeItem(3)">双</span>
          </div>
        </div>
      </div>
    </div>
